...
public class Summon_S : BaseAudioMonster, IDetectable, IDamageAble
{
    [Header("Animation")]
    ...
    void Start()
    {
        ...
        var readyStade = new S_Ready1(stateMachine, this);
        var attackState = new S_Attack1(stateMachine, this);
        var chaseState = new S_Chase1(stateMachine, this);
        var hitState = new S_Hit1(stateMachine, this);
        var dieState = new S_Die1(stateMachine, this);
    ...
    public void Damage(int atk)
    {
        if (!isHit)
        {
            ...
            {
                stateMachine.ChangeState(new S_Hit1(stateMachine, this));
            }
        }
